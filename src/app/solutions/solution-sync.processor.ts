...
export class SolutionSyncProcessor {
    ...
    public async onSolutionCreate(job: Job) {
        this.logger.debug(
            `[onSolutionCreate] Create solution in Github repository`
        );
        ...
        this.logger.debug(
            '[onSolutionCreate] Solution created in Github repository'
        );
    }
    ...
    public async onSolutionCreateFile(job: Job) {
        this.logger.debug(
            `[onSolutionCreateFile] Create solution file in Github repository`
        );
        ...
        this.logger.debug(
            '[onSolutionCreateFile] Solution file created in Github repository'
        );
    }
    ...
    public async onSolutionUpdate(job: Job) {
        this.logger.debug(
            `[onSolutionUpdate] Update solution in Github repository`
        );
        ...
        this.logger.debug(
            '[onSolutionUpdate] Solution updated in Github repository'
        );
    }
    ...
    public async onSolutionUpdateFile(job: Job) {
        this.logger.debug(
            `[onSolutionUpdateFile] Update solution file in Github repository`
        );
        ...
        this.logger.debug(
            '[onSolutionUpdateFile] Solution file updated in Github repository'
        );
    }
    ...
    public async onSolutionDelete(job: Job) {
        this.logger.debug(
            `[onSolutionDelete] Delete solution in Github repository`
        );
        ...
        this.logger.debug(
            '[onSolutionDelete] Solution deleted in Github repository'
        );
    }
}
