...
export class PermissionListener {
    ...
    public async onPermissionSet(user: UserEntity, permission: PermissionEntity): Promise<void> {
        try {
            this.logger.debug(`[onPermissionUpdate] Update project in Github repository`);
            // await this.githubApiService.(project);
            this.logger.debug('[onPermissionUpdate] Project updated in Github repository');
        } catch (err) {
            this.logger.error(
    ...
    public async onPermissionRevoke(user: UserEntity, permission: PermissionEntity): Promise<void> {
        try {
            this.logger.debug(`[onPermissionRevoke] Revoke permission in Github repository`);
