...
export class EmbeddableSyncProcessor {
    ...
    public async onEmbeddableCreate(job: Job) {
        this.logger.debug(
            `[onEmbeddableCreate] Create embeddable in Github repository`
        );
        ...
        this.logger.debug(
            '[onEmbeddableCreate] Embeddable created in Github repository'
        );
    }
    ...
    public async onEmbeddableCreateFile(job: Job) {
        this.logger.debug(
            `[onEmbeddableCreateFile] Create embeddable file in Github repository`
        );
        ...
        this.logger.debug(
            '[onEmbeddableCreateFile] Embeddable file created in Github repository'
        );
    }
    ...
    public async onEmbeddableUpdate(job: Job) {
        this.logger.debug(
            `[onEmbeddableUpdate] Update embeddable in Github repository`
        );
        ...
        this.logger.debug(
            '[onEmbeddableUpdate] Embeddable updated in Github repository'
        );
    }
    ...
    public async onEmbeddableUpdateFile(job: Job) {
        this.logger.debug(
            `[onEmbeddableUpdateFile] Update embeddable file in Github repository`
        );
        ...
        this.logger.debug(
            '[onEmbeddableUpdateFile] Embeddable file updated in Github repository'
        );
    }
    ...
    public async onEmbeddableDelete(job: Job) {
        this.logger.debug(
            `[onEmbeddableDelete] Delete embeddable in Github repository`
        );
        const { user, entity } = job.data;
        const exercise = await this.exerciseService.findOne(entity.exercise_id);
        ...
        this.logger.debug(
            '[onEmbeddableDelete] Embeddable deleted in Github repository'
        );
    }
}
