...
export class FeedbackGeneratorService {
    ...
    constructor(
        ...
        @InjectQueue(FEEDBACK_GENERATOR_SYNC_QUEUE)
        private readonly feedbackGeneratorSyncQueue: Queue,
    ...
    public async getOne(
        ...
        try {
            ...
            throw new InternalServerErrorException(
                `Failed to get feedback generator`,
                e
            );
        }
    }
    ...
    public async createOne(
        user: UserEntity,
        dto: FeedbackGeneratorEntity,
        file: any
    ): Promise<FeedbackGeneratorEntity> {
        dto.pathname = file.originalname;
        try {
            const entity = await this.repository.save(
                plainToClass(FeedbackGeneratorEntity, dto)
            );
            ...
            throw new InternalServerErrorException(
                `Failed to create feedback generator`,
                e
            );
        }
    }
    ...
    public async updateOne(
        ...
        try {
            ...
            throw new InternalServerErrorException(
                `Failed to update feedback generator`,
                e
            );
        }
    }
    ...
    public async deleteOne(
        ...
        try {
            ...
            throw new InternalServerErrorException(
                `Failed to delete feedback generator`,
                e
            );
        }
        this.feedbackGeneratorSyncQueue.add(FEEDBACK_GENERATOR_SYNC_DELETE, {
            user,
            entity
        });
        return entity;
    ...
    public async importMetadataFile(
        ...
        this.feedbackGeneratorSyncQueue.add(FEEDBACK_GENERATOR_SYNC_CREATE, {
            user,
            entity
        });
    ...
    public async getAccessLevel(
        ...
        const access_level = await getAccessLevel(
            [
                ...
                {
                    src_table: 'exercise',
                    dst_table: 'feedback_generator',
                    prop: 'feedback_generators'
                }
            ],
