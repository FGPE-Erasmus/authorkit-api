...
export class SkeletonSyncProcessor {
    ...
    public async onSkeletonCreate(job: Job) {
        this.logger.debug(
            `[onSkeletonCreate] Create skeleton in Github repository`
        );
        ...
        this.logger.debug(
            '[onSkeletonCreate] Skeleton created in Github repository'
        );
    }
    ...
    public async onSkeletonCreateFile(job: Job) {
        this.logger.debug(
            `[onSkeletonCreateFile] Create skeleton file in Github repository`
        );
        ...
        this.logger.debug(
            '[onSkeletonCreateFile] Skeleton file created in Github repository'
        );
    }
    ...
    public async onSkeletonUpdate(job: Job) {
        this.logger.debug(
            `[onSkeletonUpdate] Update skeleton in Github repository`
        );
        ...
        this.logger.debug(
            '[onSkeletonUpdate] Skeleton updated in Github repository'
        );
    }
    ...
    public async onSkeletonUpdateFile(job: Job) {
        this.logger.debug(
            `[onSkeletonUpdateFile] Update skeleton file in Github repository`
        );
        ...
        this.logger.debug(
            '[onSkeletonUpdateFile] Skeleton file updated in Github repository'
        );
    }
    ...
    public async onSkeletonDelete(job: Job) {
        this.logger.debug(
            `[onSkeletonDelete] Delete skeleton in Github repository`
        );
        ...
        this.logger.debug(
            '[onSkeletonDelete] Skeleton deleted in Github repository'
        );
    }
}
