...
export class StaticCorrectorSyncProcessor {
    ...
    public async onStaticCorrectorCreate(job: Job) {
        this.logger.debug(
            `[onStaticCorrectorCreate] Create static corrector in Github repository`
        );
        ...
        this.logger.debug(
            '[onStaticCorrectorCreate] Static corrector created in Github repository'
        );
    }
    ...
    public async onStaticCorrectorCreateFile(job: Job) {
        this.logger.debug(
            `[onStaticCorrectorCreateFile] Create static corrector file in Github repository`
        );
        ...
        this.logger.debug(
            '[onStaticCorrectorCreateFile] Static corrector file created in Github repository'
        );
    }
    ...
    public async onStaticCorrectorUpdate(job: Job) {
        this.logger.debug(
            `[onStaticCorrectorUpdate] Update static corrector in Github repository`
        );
        ...
        this.logger.debug(
            '[onStaticCorrectorUpdate] Static corrector updated in Github repository'
        );
    }
    ...
    public async onStaticCorrectorUpdateFile(job: Job) {
        this.logger.debug(
            `[onStaticCorrectorUpdateFile] Update static corrector file in Github repository`
        );
        ...
        this.logger.debug(
            '[onStaticCorrectorUpdateFile] Static corrector file updated in Github repository'
        );
    }
    ...
    public async onStaticCorrectorDelete(job: Job) {
        this.logger.debug(
            `[onStaticCorrectorDelete] Delete static corrector in Github repository`
        );
        ...
        this.logger.debug(
            '[onStaticCorrectorDelete] Static corrector deleted in Github repository'
        );
    }
}
