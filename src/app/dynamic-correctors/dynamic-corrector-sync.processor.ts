...
export class DynamicCorrectorSyncProcessor {
    ...
    public async onDynamicCorrectorCreate(job: Job) {
        this.logger.debug(
            `[onDynamicCorrectorCreate] Create dynamic corrector in Github repository`
        );
        ...
        this.logger.debug(
            '[onDynamicCorrectorCreate] Dynamic corrector created in Github repository'
        );
    }
    ...
    public async onDynamicCorrectorCreateFile(job: Job) {
        this.logger.debug(
            `[onDynamicCorrectorCreateFile] Create dynamic corrector in Github repository`
        );
        ...
        this.logger.debug(
            '[onDynamicCorrectorCreateFile] Dynamic corrector created in Github repository'
        );
    }
    ...
    public async onDynamicCorrectorUpdate(job: Job) {
        this.logger.debug(
            `[onDynamicCorrectorUpdate] Update dynamic corrector in Github repository`
        );
        ...
        this.logger.debug(
            '[onDynamicCorrectorUpdate] Dynamic corrector updated in Github repository'
        );
    }
    ...
    public async onDynamicCorrectorUpdateFile(job: Job) {
        this.logger.debug(
            `[onDynamicCorrectorUpdateFile] Update dynamic corrector in Github repository`
        );
        ...
        this.logger.debug(
            '[onDynamicCorrectorUpdateFile] Dynamic corrector updated in Github repository'
        );
    }
    ...
    public async onDynamicCorrectorDelete(job: Job) {
        this.logger.debug(
            `[onDynamicCorrectorDelete] Delete dynamic corrector in Github repository`
        );
        const { user, entity } = job.data;
        const exercise = await this.exerciseService.findOne(entity.exercise_id);
        ...
        this.logger.debug(
            '[onDynamicCorrectorDelete] Dynamic corrector deleted in Github repository'
        );
    }
}
